...
class FoodFragment(private val completed: (Order) -> Unit) : Fragment() {
    ...
    private fun setAdapter() {
        ...
        orderAdapter.submitList(
            listOf(
                Order("W0000013",
                    "https://image.istarbucks.co.kr/upload/store/skuimg/2021/07/[9300000003522]_20210723095824217.jpg",
                    "브레드",
                    "Bread"),
                Order("W0000032",
                    "https://image.istarbucks.co.kr/upload/store/skuimg/2022/04/[9300000004033]_20220406125332883.jpg",
                    "케이크",
                    "Cake"),
                Order("W0000033",
                    "https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[9300000000689]_20210421132252087.jpg",
                    "샌드위치 & 샐러드",
                    "Sandwich & Salad"),
            )
        )
